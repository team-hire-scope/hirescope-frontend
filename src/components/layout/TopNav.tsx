...
const loggedIn: null | 'company' | 'applicant' = null

const companyDisplayName = 'OO회사'

export const TopNav = () => {
	const showNav = loggedIn !== 'applicant'
			...
			<div className='justify-self-end'>
				{loggedIn === 'company' && (
					<div className='flex items-center gap-3 text-sm font-medium'>
						<span className='text-hs-deep-green'>{companyDisplayName}님 안녕하세요.</span>
